...
characteristics of low-level programming languages like C++ & Java (static typing, efficient execution, more OOP orientated).
*/
...
// To run do go run main.go (once you are in helloWorld directory)
